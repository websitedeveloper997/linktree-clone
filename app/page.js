    ...
    <main className="bg-black">
      ...
      <div className="py-10 lg:py-20">
        ...
        <section className="bg-black min-h-[100vh] grid grid-cols-1 lg:grid-cols-2 items-center">
          ...
          <div className="flex flex-col justify-center px-6 lg:ml-[10vw] gap-4 mt-10 lg:mt-28">
            ...
            <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
              ...
              <input
                ...
                className="px-4 py-3 rounded-md bg-gray-900 text-white border border-gray-700 focus:outline-none focus:border-white w-full sm:w-auto"
                type="text"
          ...
          {/* RIGHT IMAGE */}
          <div className="flex justify-center items-center mt-10 lg:mt-32 px-6 lg:mr-[130px]">
