    ...
    <main className="bg-black">
      ...
      <div className="py-10 lg:py-0">
        ...
        <section className="bg-black min-h-[50vh] grid grid-cols-1 lg:grid-cols-2 items-center">
          ...
          {/* LEFT CONTENT */}
          <div className="flex flex-col justify-center px-6 lg:ml-[10vw] gap-4 mt-10 lg:mt-0">
          ...
          {/* RIGHT IMAGE */}
          <div className="flex justify-center items-center mt-10 lg:mt-2 px-6 lg:mr-[130px]">
