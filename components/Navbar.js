...
const Navbar = () => {
  ...
  //             <Link href="/"><li className="hover:text-black">Templates</li></Link>
  //             <Link href="/"><li className="hover:text-black">Marketplace</li></Link>
  //             <Link href="/"><li className="hover:text-black">Discover</li></Link>
  //             <Link href="/"><li className="hover:text-black">Pricing</li></Link>
  //             <Link href="/"><li className="hover:text-black">Learn</li></Link>
  //           </ul>
  ...
  //           <button className="bg-gray-200 hover:bg-gray-300 transition p-4 rounded-xl font-bold">
  //             Log in
  //           </button>

  //           <button className="bg-black text-white hover:scale-105 transition font-bold p-4 rounded-full">
  //             Sign up free
  //           </button>
  //         </div>
    ...
    <>
      {showNavbar && (
        <nav className="bg-black w-[92%] lg:w-[80vw] mx-auto mt-6 lg:mt-8 rounded-full shadow-lg px-4 lg:px-7 py-3 lg:py-5 flex items-center justify-between relative transition-all">
          ...
          {/* CENTER / MOBILE LOGO (very small screens only) */}
          <div className="absolute left-1/2 -translate-x-1/2 sm:hidden">
            <Link href="/">
              <div className="cursor-pointer">

                {/* ===========================
                 PASTE YOUR SVG HERE (small logo optional)
              =========================== */}
          ...
          <ul className="hidden lg:flex items-center gap-10 text-gray-700 font-medium">
            <Link href="/"><li className="hover:text-black transition">Templates</li></Link>
            <Link href="/"><li className="hover:text-black transition">Marketplace</li></Link>
            <Link href="/"><li className="hover:text-black transition">Discover</li></Link>
            <Link href="/"><li className="hover:text-black transition">Pricing</li></Link>
            <Link href="/"><li className="hover:text-black transition">Learn</li></Link>
          </ul>

          {/* RIGHT BUTTONS */}
          <div className="flex items-center gap-2 sm:gap-3">

            <button className="bg-gray-200 hover:bg-gray-300 transition-all duration-300 px-3 sm:px-4 lg:px-5 py-2 lg:py-3 rounded-xl font-bold text-xs sm:text-sm lg:text-base">
              Log in
            </button>

            <button className="bg-black text-white hover:scale-105 hover:shadow-xl transition-all duration-300 px-3 sm:px-4 lg:px-5 py-2 lg:py-3 rounded-full font-bold text-xs sm:text-sm lg:text-base">
              Sign up free
            </button>
